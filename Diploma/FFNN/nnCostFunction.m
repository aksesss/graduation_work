...
delta3 = a3 - y';
delta2 = Theta2(1:end,2:end)'*delta3.*sigmoidGradient(z2);

Theta1_grad = Theta1_grad + delta2*[ones(1,m);a1]';
Theta2_grad = Theta2_grad + delta3*[ones(1,m);a2]';
